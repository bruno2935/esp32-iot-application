...
typedef enum wifi_app_message
{
	...
	WIFI_APP_MSG_STA_CONNECT_GOT_IP,
	WIFI_APP_MSG_USER_REQUESTED_STA_DISCONECT,
 ...
 * @node Expand this based on application requirements e.g. add another type and parameter as requiered
 */
 ...
 * @return pdTRUE if an item was successfuly sent to the queue, otherwise pdFALSE.
